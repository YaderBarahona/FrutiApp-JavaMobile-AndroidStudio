...
public class MainActivity2_NivelUno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity2_nivel_uno);
        ...
        //obtenemos el nombre enviado desde el activity ed bienvenida
    ...
    public void NumeroAleatorio(){
        ...
        //condicional para no sobrepasar el resultado a 10
        if(resultado <=10) {
        ...
        //llamamos de nuevo a la funcion (recursividad) si el resultado no es menor o igual a 10 hasta que el numero cumpla la condicion
            NumeroAleatorio();
        }

        } else {
        //si el score es igual o mayor a 10 pasar al siguiente activity con el nombre, score y vidas
            Intent in = new Intent(this, MainActivity3_NivelDos.class);
