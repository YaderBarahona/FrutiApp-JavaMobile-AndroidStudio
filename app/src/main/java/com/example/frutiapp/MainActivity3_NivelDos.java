...
public class MainActivity3_NivelDos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity3_nivel_dos);
    ...
    public void NumeroAleatorio(){
        ...
        if(score <= 19){
            ...
            Intent in = new Intent(this, MainActivity4_NivelTres.class);
