...
public class MainActivity4_NivelTres extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity4_nivel_tres);
    ...
    public void NumeroAleatorio(){
        ...
        if(score <= 29){
            ...
            Intent in = new Intent(this, MainActivity5_NivelCuatro.class);
