...
public class MainActivity7_NivelSeis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity7_nivel_seis);
        ...
        imageViewSigno = (ImageView) findViewById(R.id.imageViewSigno);
    ...
    public void NumeroAleatorio(){
        ...
        if(score <= 99){
            ...
            //condicional para cambiar el signo de la operacion y efectuar la misma
            if(numeroAleatorioUno >= 0 && numeroAleatorioUno <= 3){
                resultado = numeroAleatorioUno + numeroAleatorioDos;
                imageViewSigno.setImageResource(R.drawable.adicion);
            } else if(numeroAleatorioUno >= 4 && numeroAleatorioUno <= 7){
                resultado = numeroAleatorioUno - numeroAleatorioDos;
         ...
         /*   in.putExtra("nombre", nombreJugador);
            ...
            Toast.makeText(this, "¡Has terminado el juego, eres un genio!", Toast.LENGTH_SHORT).show();
