...
public class MainActivity5_NivelCuatro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity5_nivel_cuatro);
    ...
    public void NumeroAleatorio(){
        ...
        if(score <= 39){
            ...
            if(numeroAleatorioUno >= 0 && numeroAleatorioUno <= 4){
            ...
            Intent in = new Intent(this, MainActivity6_NivelCinco.class);
